<?php
(DEBUG_MY_PRINT) ? (myPrint('www\oficina\app\Views\saotiago\service\create_form.php', 'Line: 2', true)) : (NULL);
$form = [
    'action' => 'saotiago/service/api/create',
...
<div class="d-flex justify-content-center">
    <div class="card text-center" style="width: 95%;">
        ...
        <div class="card-body">
            <div class="row">
                <div class="col-12 col-sm-4">
                    <div class="text-start">
                        <button class="btn btn-outline-primary" type="button" data-bs-toggle="collapse" data-bs-target="#collapseService" aria-expanded="false" aria-controls="collapseService">
            ...
            <?= view('saotiago/service/form_field') ?>
        </div>
