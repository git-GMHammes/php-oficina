...
class ServiceEndPointController extends ResourceController
{
    use ResponseTrait;
    ...
    public function index()
    {
        try {
            ...
            $apiRespond = [
                'message' => 'API loading data (dados para serviceregamento da API)',
                'date' => date('Y-m-d'),
                'uri' => $this->uri,
                // 'method' => '__METHOD__',
    ...
    # Consumo de API
    # route GET /www/saotiago/service/endpoint/create(:any)
    # route POST /www/saotiago/service/endpoint/create
    ...
    # Consumo de API
    # route GET /www/saotiago/service/endpoint/create_os(:any)
    # route POST /www/saotiago/service/endpoint/create_os
    # Informação sobre o controller
    # retorno do controller [VIEW]
    public function create_os()
    {
        ...
        $loadView = array(
            ...
            $this->menu,
            $this->message,
            'saotiago/service/create_form_os'
        );
        try {
            $return['menu_profile'] = $this->menu_profile;
            $apiRespond = array(
