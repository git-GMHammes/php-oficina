...
use App\Models\CarManufacturerModelModel;
use App\Models\CarManufacturerModel;
use Exception;

class CarManufacturerModelApiController extends ResourceController
{
    use ResponseTrait;
    ...
    {
        $this->ModelModel = new CarManufacturerModelModel();
        $this->ModelManufacturer = new CarManufacturerModel();
    ...
    # route POST /www/saotiago/model/api/index/(:any)
    # route GET /www/saotiago/model/api/index/(:any)
    # Informação sobre o controller
    # retorno do controller [JSON]
    public function index($parameter = NULL)
    {
        $manufacturer = $this->ModelManufacturer->dbRead()->findAll();
        $model = $this->ModelModel->dbRead()->findAll();
        try {
            $apiRespond = [
                'http' => array(
    ...
    # route POST /www/saotiago/model/api/read/(:any)
    # route GET /www/saotiago/model/api/read/(:any)
    # Informação sobre o controller
    # retorno do controller [JSON]
    public function read($parameter = NULL)
    {
        ...
        # 
        $dbResponse = $this->ModelModel->dbread()->findAll();
        // myPrint($dbResponse, 'www\oficina\app\Controllers\CarManufacturerModelApiController.php, Line: 75', true);
        try {
