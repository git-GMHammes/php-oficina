...
class WarrantieEndPointController extends ResourceController
{
    use ResponseTrait;
    ...
    # Consumo de API
    # route GET /www/saotiago/warranties/endpoint/create/(:any)
    # route POST /www/saotiago/warranties/endpoint/create/(:any)
    # Informação sobre o controller
    ...
    public function create($parameter = NULL)
    {
        ...
        $loadView = array(
            ...
            $this->menu,
            $this->message,
            'saotiago/warrantie/create_form'
        );
        try {
            # URI da API
            $uri = base_url() . '/sigla/rota/' . $parameter;
