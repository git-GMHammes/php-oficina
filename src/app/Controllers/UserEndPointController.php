...
class UserEndPointController extends ResourceController
{
    use ResponseTrait;
    ...
    # Consumo de API
    # route GET /www/saotiago/user/endpoint/authenticate(:any)
    # route POST /www/saotiago/user/endpoint/authenticate
    ...
    public function authenticate()
    {
        ...
        $loadView = array(
            ...
            $this->menu,
            $this->message,
            'saotiago/user/authenticate/form'
        );
        try {
            $return['menu_profile'] = $this->menu_profile;
            // myPrint($return, 'app\Controllers\UserEndPointController.php');
            $apiRespond = array(
                'result' => $return,
                'loadView' => $loadView
            );
    ...
    # Consumo de API
    # route GET /www/saotiago/user/endpoint/create(:any)
    # route POST /www/saotiago/user/endpoint/create
    # Informação sobre o controller
    # retorno do controller [VIEW]
    public function create()
    {
        ...
        $loadView = array(
            ...
            $this->menu,
            $this->message,
            'saotiago/user/create/create_form'
        );
        try {
            $return['menu_profile'] = $this->menu_profile;
            $apiRespond = array(
