...
class ProductEndPointController extends ResourceController
{
    use ResponseTrait;
    ...
    # Consumo de API
    # route GET /www/saotiago/product/endpoint/create/(:any)
    # route POST /www/saotiago/product/endpoint/create/(:any)
    # Informação sobre o controller
    # retorno do controller [VIEW]
