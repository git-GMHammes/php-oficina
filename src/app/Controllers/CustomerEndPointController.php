...
class CustomerEndPointController extends ResourceController
{
    use ResponseTrait;
    ...
    # Consumo de API
    # route GET /www/saotiago/customer/endpoint/create(:any)
    # route POST /www/saotiago/customer/endpoint/create
